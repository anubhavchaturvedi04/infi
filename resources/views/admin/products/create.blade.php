    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card card-info border-secondary">
                ...
                <div class="card-body">
                    <form action="{{route('saveProductAdmin')}}" id="saveProduct" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="capacity" placeholder="Capacity" >
                          </div>
                          <div class="form-group">
...
<label>Pieces Per Box</label>                          <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="pieces_per_box" placeholder="Pieces Per Box">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="meta_keywords"  class="form-control ckeditor" required></textarea>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Meta Description</label>
                            <textarea name="meta_description"  class="form-control ckeditor" required></textarea>
                          </div>
