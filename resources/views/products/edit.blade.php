                  ...
                  <form action="{{route('updateProduct')}}" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$product->packing_type}}" id="exampleInputEmail1" aria-describedby="emailHelp" name="packing_type" placeholder="Packing Type" >
                          </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="pieces_per_box" value="{{$product->pieces_per_box}}" placeholder="Pieces Per Box">
                        </div>
                        @foreach($attributes as $attribute)
                          ...
                          <div class="form-group">
                            ...
                            <input type="file" accept="image/*" multiple class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="image" placeholder="Product Image">
                          </div>
