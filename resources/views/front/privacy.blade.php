...
<div class="body-content">
	...
	<div class="">
		...
		<h3>Security:</h3>
		<p>
			We safeguard your privacy using known security standards and procedures and comply with applicable privacy laws. Our websites combine industry-approved physical, electronic and procedural safeguards to ensure that your information is well protected though it's life cycle in our infrastructure. We are using profile information and email information from google plus login api. We are using it for internal purpose only, we are not sharing this information with anyone.Sensitive data is hashed or encrypted when it is stored in our infrastructure. Sensitive data is decrypted, processed and immediately re-encrypted or discarded when no longer necessary. We host web services in audited data centers, with restricted access to the data processing servers. Controlled access, recorded and live-monitored video feeds, 24/ 7 staffed security and biometrics provided in such data centers ensure that we provide secure hosting.
		</p>
		<h3>Opt-Out Policy:</h3>
		<p>
			Please email to us at if you no longer wish to receive any information from us.
		</p>
	</div>
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
