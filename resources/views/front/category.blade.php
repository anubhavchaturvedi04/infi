                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        ...
                                                        @endphp
                                                        <a href="{{route('getProduct',['slug'=>$slug,'product'=>$product->slug])}}"><img src="{{asset('public/product/'.$image[0])}}" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="{{route('getProduct',['slug'=>$slug,'product'=>$product->slug])}}">{{$product->title}}</a></h3>
					...
					<i class="fa fa-inr"></i>{{$product->price}}				</span>
								...
								<i class="fa fa-shopping-cart"></i>													
                                                            ...
                                                            <li class="lnk wishlist">
                                                                <a class="add-to-cart" href="{{route('getProduct',['slug'=>$slug,'product'=>$product->slug])}}" title="Wishlist">
								 <i class="icon fa fa-heart"></i>
							</a>
                                                            </li>

                                                            <li class="lnk">
                                                                <a class="add-to-cart" href="{{route('getProduct',['slug'=>$slug,'product'=>$product->slug])}}" title="Compare">
