        ...
        <div class="row">
            <div class="col-md-3 sidebar">
                ...
                <div class="sidebar-module-container">
                 ...
                 <span class="pull-left">$200.00</span>
                                    ...
                                    </div><input type="text" class="price-slider" value="200,500" data="value: '200,500'" style="display: none;">
            ...
            <div class="col-md-9">
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image">
                            <img src="{{asset('/public/slider/slider_1.jpg')}}" alt="" class="img-responsive">
                        </div>
                                        ...
                                        <div class="products">
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        @php
                                                            $image=explode(',',$product->product->image);
                                                        @endphp
                                                        <a href="{{route('getUtilityProduct',['slug'=>$slug,'product'=>$product->product->slug])}}"><img src="{{asset('public/product/'.$image[0])}}" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="{{route('getUtilityProduct',['slug'=>$slug,'product'=>$product->product->slug])}}">{{$product->product->title}}</a></h3>
                                                    <!-- <div class="rating rateit-small rateit"><button id="rateit-reset-13" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-13" style="display: none;"></button>
                                                        <div id="rateit-range-13" class="rateit-range"
                                                            tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-13" aria-valuemin="0" aria-valuemax="5" aria-valuenow="4" aria-readonly="true" style="width: 70px; height: 14px;">
                                                    ...
                                                    <div class="product-price">
                                                        <span class="price">
					<i class="fa fa-inr"></i>{{$product->product->price}}				</span>
								...
								<i class="fa fa-shopping-cart"></i>													
                                                            ...
                                                            <li class="lnk wishlist">
                                                                <a class="add-to-cart" href="{{route('getUtilityProduct',['slug'=>$slug,'product'=>$product->slug])}}" title="Wishlist">
								 <i class="icon fa fa-heart"></i>
							</a>
                                                            </li>

                                                            <li class="lnk">
                                                                <a class="add-to-cart" href="{{route('getUtilityProduct',['slug'=>$slug,'product'=>$product->slug])}}" title="Compare">
                                                ...
                                                <div class="col col-sm-4 col-lg-4">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            ...
                                                            $image=explode(',',$product->product->image);
                                                        @endphp
                                                            <img src="{{asset('/public/product/'.$image[0])}}" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- /.product-image -->
                                                </div>
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        ...
                                                        <!-- <div class="rating rateit-small rateit"><button id="rateit-reset-25" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-25" style="display: none;"></button>
                                                            <div id="rateit-range-25" class="rateit-range"
                                                                tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-25" aria-valuemin="0" aria-valuemax="5" aria-valuenow="4" aria-readonly="true" style="width: 70px; height: 14px;">
                                                                <div class="rateit-selected" style="height: 14px; width: 56px;"></div>
                                                                <div class="rateit-hover" style="height:14px"></div>
                                                            </div>
                                                        </div> -->
						...
						<i class="fa fa-inr"></i>{{$product->product->price}}					</span>
                                                        ...
                                                        <!-- /.product-price -->
                                                        <div class="description m-t-10">{{$product->product->description}}</div>
                                                        <!-- <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    <li class="add-cart-button btn-group">
